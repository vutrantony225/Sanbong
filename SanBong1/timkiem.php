                ...
                if ($products) {
                    ...
                    if ($num > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($products)) {
                            ...
                            echo '<p>Giá: ' . $row['Gia'] . ' đ</p>';
                            echo '<p>Loại sân: ' . $row['LoaiSan'] . '</p>';
                            echo '<button type="submit" name="datsan[' . $row['ID'] . ']" class="btn btn-danger">Đặt sân</button> ';
                            echo '<button type="submit" name="chitiet[' . $row['ID'] . ']" class="btn btn-info">Chi tiết</button>';
                            echo '</form></div></div>';
                        }
                        echo '</div></div>';
                    } else {
